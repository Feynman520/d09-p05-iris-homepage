...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.36', bytes: 540992407, date: '2026-09-23', asset: 'IRIS-Setup_v2.0.36_2026-09-23.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.36/IRIS-Setup_v2.0.36_2026-09-23.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.36', // 릴리스 노트 쪽
        sha: '3c21043103bf52248685b2c7f841fc157e4708a56b84bd02653c42ddc97b6e6c' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
