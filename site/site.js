...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.14', bytes: 383149387, date: '2026-09-17', asset: 'IRIS-Setup_v2.0.14_2026-09-17.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.14/IRIS-Setup_v2.0.14_2026-09-17.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.14', // 릴리스 노트 쪽
        sha: '25a633084a75da0279791ed6d4845f04d3802036e0201e98210f225538497b60' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
    ...
    mirror: { base: 'https://pub-6bb549660d7d4bd79ed07a7b6523f5c5.r2.dev', assets: ['IRIS-Setup_v2.0.14_2026-09-17.zip'] },
  };
