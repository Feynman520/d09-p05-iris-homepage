...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      face: { version: 'v2.75.0' },
      messenger: { version: 'v0.4.3' },
      installer: { version: 'v2.0.37', bytes: 540992645, date: '2026-09-23', asset: 'IRIS-Setup_v2.0.37_2026-09-23.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.37/IRIS-Setup_v2.0.37_2026-09-23.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.37', // 릴리스 노트 쪽
        sha: '0c6f7dd29445e70fb3ab21b8d711749c22c48bdc1afb09036824d1d8e1f5eefb' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
  ...
  const I18N = {
    en: {
      ...
      'faq.7q': 'Is a ChatGPT subscription alone enough?', 'faq.7a': 'Yes. Pick only ChatGPT in the installer and Codex takes the lead — the first session and the default agent for new sessions are Codex, and Claude Code is not downloaded. If you get a Claude subscription later, add the account from the usage screen in the IRIS window.',
      ...
      'inst.s4h': '③ Subscription', 'inst.s4': 'Tick every paid subscription you have: Claude, ChatGPT, or both. With both, Claude Code leads and both are used afterwards. With ChatGPT only, Codex leads and Claude Code is not downloaded.',
