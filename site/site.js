...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.8', bytes: 383147547, date: '2026-09-17', asset: 'IRIS-Setup_v2.0.8_2026-09-17.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.8/IRIS-Setup_v2.0.8_2026-09-17.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.8', // 릴리스 노트 쪽
        sha: 'd4c89aafcd0a48c5b3becaec7adcd1635cf0f8a32047a05c0326a76ae6e7e791' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
