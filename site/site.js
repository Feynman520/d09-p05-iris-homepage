...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.21', bytes: 540956912, date: '2026-09-19', asset: 'IRIS-Setup_v2.0.21_2026-09-19.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.21/IRIS-Setup_v2.0.21_2026-09-19.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.21', // 릴리스 노트 쪽
        sha: '35217da2e0103664dd8a7f6172522cb8ba12ab8e338221fc63443f17238b9a1a' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
    ...
    mirror: { base: 'https://pub-6bb549660d7d4bd79ed07a7b6523f5c5.r2.dev', assets: ['IRIS-Setup_v2.0.19_2026-09-18.zip', 'IRIS-Setup_v2.0.20_2026-09-18.zip', 'IRIS-Setup_v2.0.21_2026-09-19.zip'] },
  };
