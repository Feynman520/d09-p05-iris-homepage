...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.6', bytes: 383143492, date: '2026-09-17', asset: 'IRIS-Setup_v2.0.6_2026-09-17.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.6/IRIS-Setup_v2.0.6_2026-09-17.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.6', // 릴리스 노트 쪽
        sha: '254085e1317d089105462e7fa2673aea0210a477c906fec66eee6f8b9550127e' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
