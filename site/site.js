...
(function () {
  ...
  const CONFIG = {
    ...
    fallback: {
      ...
      installer: { version: 'v2.0.13', bytes: 383149578, date: '2026-09-17', asset: 'IRIS-Setup_v2.0.13_2026-09-17.zip',
        url: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/download/iris-installer--v2.0.13/IRIS-Setup_v2.0.13_2026-09-17.zip', // 첨부 직접 주소(단추를 누르면 바로 내려받기)
        page: 'https://github.com/Feynman520/d09-p03-iris-installer/releases/tag/iris-installer--v2.0.13', // 릴리스 노트 쪽
        sha: '8cdcc144084316ab5908c897ca3dc5cf36604bd3a0c159e1b2e44d2bac276e76' }, // 릴리스 첨부 .sha256 은 CORS 가 막혀 브라우저가 못 읽는다 → 아는 판의 값만 여기 둔다
    },
    ...
    mirror: { base: 'https://pub-6bb549660d7d4bd79ed07a7b6523f5c5.r2.dev', assets: ['IRIS-Setup_v2.0.13_2026-09-17.zip'] },
  };
